              ...
              <div class="row">
                ...
                <div class="col-xxl">
                  <div class="card mb-4">
                    ...
                    <div class="card-body">
                      <form class="body_box" action="{{Route('UserSalonBook.store')}}" method="post">
                        @csrf
                        <div class="row_book">
                        ...
                        <div class="row_book">
                            ...
                            <div class="col-12">
                                <label for="Salon_Services_Id">Choose a Services:</label>
        
                                <select name="Salon_Services_Id" id="services"  value="{{ old('Salon_Services_Id')}}" class="@error('Salon_Services_Id') is-invalid @enderror">
