        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Form/</span> Home Services</h4>
              ...
              <div class="row">
                ...
                <div class="col-xxl">
                  <div class="card mb-4">
                    ...
                    <div class="card-body">
                        {{-- ///////////////////form --}}
                      <form action="{{route('homeServices.store')}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row mb-3">
