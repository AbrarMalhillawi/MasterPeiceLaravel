...
<head>
	...
	<div id="booking" class="section" style="background-image: url({{ asset('/storage/homeserviceimage/' . $HomeService->image) }})";>
		<div class="section-center">
			<div class="container">
				<div class="row">
					<div class="col-md-4">
						<div class="booking-cta">
							<h1>Enjoy The Best Booking  At {{$HomeService->name}} For Home Services</h1>
					...
					<div class="col-md-7 col-md-offset-1">
						<div class="booking-form">
							<form action="{{Route('UserHomeBook.store')}}" method="post">
								@csrf
								<div class="row">
									<div class="col-md-6">
								...
								<div class="row">
									...
									<div class="col-md-6">
										<div class="form-group">
											...
											<select class="form-control" name="Home_Services_Id" id="services"  value="{{ old('Home_Services_Id')}}" class="@error('Home_Services_Id') is-invalid @enderror">
								...
								<div class="row">
									<div class="col-md-12">
										<div class="form-group">
											...
											<input type="hidden" class="form-control bg-transparent" id="HomeService" placeholder="HomeService" name="HomeServicesName" value="{{ $HomeService->name }}">
										</div>
									</div>
